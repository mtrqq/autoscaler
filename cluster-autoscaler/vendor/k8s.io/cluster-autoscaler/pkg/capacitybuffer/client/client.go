...
import (
	...
	capacitybuffer "k8s.io/cluster-autoscaler/apis/capacitybuffer/client/clientset/versioned"
	"k8s.io/cluster-autoscaler/apis/capacitybuffer/client/informers/externalversions"
	bufferslisters "k8s.io/cluster-autoscaler/apis/capacitybuffer/client/listers/autoscaling.x-k8s.io/v1beta1"
