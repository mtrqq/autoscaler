...
import (
	...
	provisioningrequestautoscalingxk8siov1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/autoscaling.x-k8s.io/v1"
	...
	autoscalingxk8siov1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/listers/autoscaling.x-k8s.io/v1"
)
