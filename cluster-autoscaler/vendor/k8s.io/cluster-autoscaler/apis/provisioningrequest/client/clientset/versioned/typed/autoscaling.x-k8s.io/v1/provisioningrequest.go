...
import (
	...
	autoscalingxk8siov1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/autoscaling.x-k8s.io/v1"
	applyconfigurationautoscalingxk8siov1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/applyconfiguration/autoscaling.x-k8s.io/v1"
