...
import (
	...
	"k8s.io/cluster-autoscaler/apis/provisioningrequest/client/clientset/versioned"
	"k8s.io/cluster-autoscaler/apis/provisioningrequest/client/informers/externalversions"
	listers "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/listers/autoscaling.x-k8s.io/v1"
