...
import (
	...
	cbv1beta1 "k8s.io/cluster-autoscaler/apis/capacitybuffer/autoscaling.x-k8s.io/v1beta1"
	"k8s.io/cluster-autoscaler/pkg/capacitybuffer"
	capacityclient "k8s.io/cluster-autoscaler/pkg/capacitybuffer/client"
	cbctrl "k8s.io/cluster-autoscaler/pkg/capacitybuffer/controller"
	...
	"k8s.io/cluster-autoscaler/pkg/core/podlistprocessor"
	"k8s.io/cluster-autoscaler/pkg/core/scaleup/orchestrator"
	...
	cbprocessor "k8s.io/cluster-autoscaler/pkg/processors/capacitybuffer"
	"k8s.io/cluster-autoscaler/pkg/processors/nodegroupset"
	"k8s.io/cluster-autoscaler/pkg/processors/nodeinfosprovider"
	"k8s.io/cluster-autoscaler/pkg/processors/podinjection"
	podinjectionbackoff "k8s.io/cluster-autoscaler/pkg/processors/podinjection/backoff"
	"k8s.io/cluster-autoscaler/pkg/processors/pods"
	"k8s.io/cluster-autoscaler/pkg/processors/provreq"
	"k8s.io/cluster-autoscaler/pkg/processors/scaledowncandidates"
	"k8s.io/cluster-autoscaler/pkg/processors/scaledowncandidates/emptycandidates"
	"k8s.io/cluster-autoscaler/pkg/processors/scaledowncandidates/previouscandidates"
	"k8s.io/cluster-autoscaler/pkg/processors/status"
	"k8s.io/cluster-autoscaler/pkg/provisioningrequest/besteffortatomic"
	"k8s.io/cluster-autoscaler/pkg/provisioningrequest/checkcapacity"
	provreqorchestrator "k8s.io/cluster-autoscaler/pkg/provisioningrequest/orchestrator"
	"k8s.io/cluster-autoscaler/pkg/provisioningrequest/provreqclient"
	"k8s.io/cluster-autoscaler/pkg/simulator/clustersnapshot"
	"k8s.io/cluster-autoscaler/pkg/simulator/clustersnapshot/predicate"
	"k8s.io/cluster-autoscaler/pkg/simulator/clustersnapshot/store"
	...
	"k8s.io/cluster-autoscaler/pkg/simulator/scheduling"
