...
import (
	...
	capacitybufferpodlister "k8s.io/cluster-autoscaler/pkg/processors/capacitybuffer"
	...
	simulator_fake "k8s.io/cluster-autoscaler/pkg/simulator/fake"
	"k8s.io/cluster-autoscaler/pkg/simulator/framework"
	"k8s.io/cluster-autoscaler/pkg/utils/daemonset"
