...
import (
	...
	testcloudprovider "k8s.io/cluster-autoscaler/pkg/cloudprovider/test"
	...
	"k8s.io/cluster-autoscaler/pkg/expander/random"
	"k8s.io/cluster-autoscaler/pkg/metrics"
	processor_callbacks "k8s.io/cluster-autoscaler/pkg/processors/callbacks"
	...
	"k8s.io/cluster-autoscaler/pkg/simulator/clustersnapshot/testsnapshot"
	...
	"k8s.io/cluster-autoscaler/pkg/utils/labels"
