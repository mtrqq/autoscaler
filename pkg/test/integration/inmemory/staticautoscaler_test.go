...
import (
	...
	fakecloudprovider "k8s.io/cluster-autoscaler/pkg/cloudprovider/test"
	"k8s.io/cluster-autoscaler/pkg/test/integration"
	synctestutils "k8s.io/cluster-autoscaler/pkg/test/integration/synctest"
