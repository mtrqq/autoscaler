...
import (
	...
	autoscalingxk8siov1beta1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/autoscaling.x-k8s.io/v1beta1"
	applyconfigurationautoscalingxk8siov1beta1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/applyconfiguration/autoscaling.x-k8s.io/v1beta1"
	scheme "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/clientset/versioned/scheme"
)
