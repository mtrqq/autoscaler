...
import (
	...
	provisioningrequestautoscalingxk8siov1beta1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/autoscaling.x-k8s.io/v1beta1"
	versioned "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/clientset/versioned"
	internalinterfaces "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/informers/externalversions/internalinterfaces"
	autoscalingxk8siov1beta1 "k8s.io/cluster-autoscaler/apis/provisioningrequest/client/listers/autoscaling.x-k8s.io/v1beta1"
)
